"""
Django settings for hakunaBE project.
...
SECRET_KEY = 'django-insecure-5n5ze-gssf@n53xi$bl&d#psi=3ll^44o%pozpilywp__*ndqg'
...
WSGI_APPLICATION = 'hakunaBE.wsgi.application'
